...
export default function Purchases() {
  ...
  const handleUpdateClick = (purchase: Purchase) => {
    ...
    setUpdateData({
      ...
      expense: purchase.expense?.toString() || '',
      notes: '',
    })
            ...
            <form onSubmit={handleUpdateSubmit} className="p-4 space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mb-2">
                  ...
                  {editingPurchase.expense && editingPurchase.expense > 0 && (
                    <span className="text-xs text-gray-500 ml-2">(Expense: Rs {editingPurchase.expense.toLocaleString('en-IN', {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })})</span>
                  )}
